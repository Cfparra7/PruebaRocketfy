...
export class EditProductoComponent implements OnInit {
  ...
  actualizar(actualizarForm:any){
    if(actualizarForm.valid){
      ...
      if(!this.producto.precio_antes_pesos || this.producto.precio_antes_pesos == undefined){
        this.producto.precio_antes_pesos = 0;
      }
      ...
      data.precio_antes_pesos = this.producto.precio_antes_pesos;
